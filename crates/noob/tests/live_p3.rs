...
//! load-and-use round trip against the local endpoint, through the shipped
//! binary. This is gauntlet item 5: the resolver index routes the model to
//! the skill, the body arrives as a tool result, and its content shapes the
//! answer.
